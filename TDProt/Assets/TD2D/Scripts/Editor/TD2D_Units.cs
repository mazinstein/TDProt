	...
	void OnGUI()
	{
		...
		if (EditorApplication.isPlaying == false)
		{
			...
			if (myState != MyState.Disabled)
			{
				...
				if (unitData.gameObject != null && PrefabUtility.GetPrefabAssetType(unitData.gameObject) != PrefabAssetType.NotAPrefab)
				{
					if (GUILayout.Button(contents.applyChangesButton) == true)
					{
                        ...
                        PrefabUtility.ApplyPrefabInstance(unitData.gameObject.gameObject, InteractionMode.AutomatedAction);
