...
public class TowerUI : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    void Start()
    {
        Debug.Log("TowerUI Start called");
    }
    ...
    public void SetTowerPrefab (Tower tower)
    {
        ...
        _towerPrefab = tower;
        var icon = tower.GetTowerHeadIcon();
        Debug.Log("SetTowerPrefab: " + (icon != null ? icon.name : "null"));
    ...
    {
    Debug.Log($"Begin drag: towerPrefab = {(_towerPrefab != null ? _towerPrefab.name : "null")}");
